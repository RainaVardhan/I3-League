      ...
      <main id="main" className={styles.page}>
        <div className={styles.inner}>
          ...
          <div className={styles.notice}>
            <strong>Draft: pending legal review.</strong> This document
            establishes the shape of our {title.toLowerCase()} for the 2026–2027
            season launch. It has not yet been reviewed by counsel and should
            not be treated as final. Questions in the meantime can go to{" "}
